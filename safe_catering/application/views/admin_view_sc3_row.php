        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div id="main-content">
                    <div class="row">
                        <div class="col-md-3">
                 <a href="<?php echo base_url(); ?>Admin/safe_catering_3" class="btn btn-success">Back</a>
                 <br> <br>
   <table class="table table-striped table-bordered">
                    
                    <?php
                    foreach($sc3_data as $row)
                    {
                        ...
                        <tr>
                            <th>Manager Superviser Check</th>
