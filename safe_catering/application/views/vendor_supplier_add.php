...
<body>
    ...
    <div class="content-wrap">
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>ADD SUPPLIER<span><a href="<?php echo base_url(); ?>Login/logout"></span></h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
      ...
      <?php
        ...
        <form action="<?php echo base_url(); ?>Vendor/supplier_insert" method="post">

<div class="form-group">
    <label>Supplier Name</label>
    <input type="text" class="form-control" name="sup_name">
</div>
    <input type="hidden" name="sup_user_id" value="<?php echo $this->session->userdata('user_id'); ?>">
