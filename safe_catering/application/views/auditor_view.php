                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>AUDITOR<span><a href="<?php echo base_url(); ?>Login/logout"></span></h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
          ...
          $count =0; 
           ...
           $count++;
						...
						<tr>            <td>'.$row->user_id.'</td>
                            ...
                            <td><button class="btn btn-primary"><a href="'.base_url().'Admin/edit_auditor/'.$row->user_id.'">EDIT</a></button></td>
...
function suspend_user(userid){ 
    //alert(userid);
     ...
     $.ajax({
         type: "POST",
         url:"<?php echo base_url(); ?>Admin/suspend_auditor_1", 
         data: {id:userid},
         dataType: "text",  
         async: false,
...
function deletePost(ud_id,user_id) {
    ...
    if (ask) {
        window.location.href = '<?php echo  base_url()."Admin/delete_id/"; ?>'+ud_id+'/'+user_id;
...
function make_active_user(userid){ 
     ...
     $.ajax({
         type: "POST",
         url:"<?php echo base_url(); ?>Admin/make_active_auditor", 
         data: {id:userid},
         dataType: "text",  
         async: false,
         success: function(response) {
