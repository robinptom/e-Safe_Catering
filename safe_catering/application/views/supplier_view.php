				...
				<table class="table table-striped table-bordered">
					...
					foreach($data as $row)
					{
						...
						<tr>
                            ...
                            <td>'.$row->sup_created.'</td>
                            <td>'.$this->encrypt->decode($row->ud_fname).'</td> 
                            <td><button class="btn btn-primary"><a href="'.base_url().'Admin/edit_view_supplier/'.$row->sup_id.'">EDIT</a></button></td>
                            <td><button class="btn btn-primary"><a href="'.base_url().'Admin/delete_supplier?id='.$row->sup_id.'">DELETE</a></button></td>
						</tr>
						';
