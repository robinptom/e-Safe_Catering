...
<body>
   ...
   <form action="<?php echo base_url(); ?>Vendor/sc3_insert" method="post" id="scform">  


  <div class="form-group">
    <label>Food:</label>
    <input type="text" class="form-control" name="sc3_food" required> 
  </div>


<div class="form-group">
    <label>Time started Cooking<span>(24 hour format)</span>:</label>
    <!-- <input type="time" class="form-control time" name="sc3_time_started_cooking" required>  -->
            <div class="input-group bootstrap-timepicker timepicker">
            <input type="text" name="sc3_time_started_cooking" class="form-control input-small timepicker2">
  ...
  <div class="form-group">
    <label>Time Finished Cooking<span>(24 hour format)</span>:</label>
    <!-- <input type="time" class="form-control time" name="sc3_time_finished_cooking" required>  -->

     <div class="input-group bootstrap-timepicker timepicker">
            <input type="text" name="sc3_time_finished_cooking" class="form-control input-small timepicker2" required>
            <span class="input-group-addon">
                <i class="glyphicon glyphicon-time"></i>
            </span>
        </div>
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" name="sc3_core_temp" required> 
  </div>

 <!--  <div class="form-group">
    <label>Signed:</label>
    <input type="text" class="form-control" name="sc3_sign" required> 
  </div> -->

  <div class="form-group">
    <label>Time into Fridge Blast Chiller <span>(24 hour format)</span></label>
    <!-- <input type="time" class="form-control time" name="sc3_time_into_fridge_bchiller" required>  -->
    <div class="input-group bootstrap-timepicker timepicker">
            <input type="text" name="sc3_time_into_fridge_bchiller" class="form-control input-small timepicker2" required>
            <span class="input-group-addon">
                <i class="glyphicon glyphicon-time"></i>
            </span>
        </div>
...
<!-- 
 <div class="form-group">
    <label>Signed:</label>
    <input type="text" class="form-control" name="sc3_bchiller_sign" required> 
  </div> -->

  <div class="form-group">
    <label>Comments/Action</label>
    <input type="text" class="form-control"  name="sc3_comments_action" required>
  </div>

<input type="hidden" value="<?php echo $this->session->userdata('user_id'); ?>" name="sc3_user_id">
            
   <input type="submit" class="btn btn-success" value="CREATE SC3 FORM">
        </form>
        <br>
    </div>      
        </div>
