...
<form action="<?php echo base_url(); ?>Vendor/reports" method="post">
    ...
    <select name="sc_form_type"  required>
        <option value="4"><?php echo $dropdown; ?></option>
   ...
   <button type="submit" name="sc4_report" value="sc4_repport" class="btn btn-success"><i class="glyphicon glyphicon-download-alt"></i>Download Records</button>
</form>
<br/>
