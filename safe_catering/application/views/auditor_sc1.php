        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div id="main-content">
                    <div class="row">
                        <br>
                 <a href="<?php echo base_url(); ?>Auditor/sc1_dwld_pdf" class="btn btn-success"><i class="glyphicon glyphicon-download-alt"></i> Download Records</a>
                 <br> <br>
   <table class="table table-striped table-bordered">
                    ...
                    foreach($data as $row)
                    {
                        ...
                        <tr>
                            ...
                            <td><a href="'.base_url().'Auditor/auditor_sc1_view/'.$row->sc1_id.'" class="btn btn-primary" ><i class="glyphicon glyphicon-th-list" ></i></a></td>

                            <td><a href="'.base_url().'Auditor/pdf/'.$row->sc1_id.'" class="btn btn-success"><i class="glyphicon glyphicon-download-alt"></i></a></td>
