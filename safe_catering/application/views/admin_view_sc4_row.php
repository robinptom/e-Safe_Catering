        ...
        <div class="main">
            <div class="container-fluid">
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>SC 4 VIEW- DISPLAY RECORDS</h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                ...
                <div id="main-content">
                    <div class="row">
                        <div class="col-md-3">
                 <a href="<?php echo base_url(); ?>Admin/safe_catering_4" class="btn btn-success">Back</a>
                 <br> <br>
   <table class="table table-striped table-bordered">
                    
                    <?php
                    foreach($sc4_data as $row)
                    {
