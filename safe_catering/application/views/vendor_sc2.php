...
<body>
  ...
  <?php if ($this->session->flashdata('error')) { ?>
    ...
    <form action="<?php echo base_url(); ?>Vendor/sc2_insert" method="post" id="scform">  
  <div class="form-group">
    <label>REFRIGERATION UNIT NAME:</label>
    <input type="text" class="form-control" name="sc2_unit" required>
  </div>

   <div class="form-group">
    <label>TEMPERATURE(&#X00B0;C):</label>
    <input type="number" class="form-control" name="sc2_temperature" required>
  </div>
  <div class="form-group">
    <label>Comments/Action</label>
    <input type="text" class="form-control"  name="sc2_comments_action" required>
  </div>


<input type="hidden" value="<?php echo $this->session->userdata('user_id'); ?>" name="created_by">
<input type="submit" class="btn btn-success" value="CREATE SC2 FORM">
        </form>
        <br>
    </div>      
        </div>
