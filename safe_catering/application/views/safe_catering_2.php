...
<body>
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>SC 2 - REFRIGERATION<span><a href="<?php echo base_url(); ?>Login/logout"></span></h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
    ...
    <div class="row">
        <br>
            <a href="<?php echo base_url(); ?>Admin/sc2_dwld_pdf" class="btn btn-success"><i class="glyphicon glyphicon-download-alt"></i> Download Records</a>
            <br><br>
				<table class="table table-striped table-bordered">
                    ...
                    foreach($data as $row)
                    {
                        ...
                        <tr>
                            ...
                            <td>'.$row->sc2_mgr_supvsr_check.'</td>
                            <td>'.$this->encrypt->decode($row->sc2_mgr_sign).'</td>
                            <td>'.$this->encrypt->decode($row->ud_fname).'</td>
                            <td><a href="'.base_url().'Admin/admin_sc2_view/'.$row->sc2_id.'" class="btn btn-primary" ><i class="glyphicon glyphicon-th-list" ></i></a></td>

                            <td><a href="'.base_url().'Admin/pdf_sc2/'.$row->sc2_id.'" class="btn btn-success"><i class="glyphicon glyphicon-download-alt"></i></a></td>
                        </tr>
                        ';
