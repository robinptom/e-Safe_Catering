...
<body>
    ...
    <div id="main-content">
				 ...
				 <div class="row">
                    <br>
            <a href="<?php echo base_url(); ?>Admin/sc4_dwld_pdf" class="btn btn-success"><i class="glyphicon glyphicon-download-alt"></i> Download Records</a>
            <br><br>
   ...
   <table class="table table-striped table-bordered">
                    <tr>
                        ...
                        <th>Food</th>
                        <th>Hot Hold Time</th>
                        <th>Core Temperature check 1</th>
                        <th>Core Temperature check 2</th>
                        <th>Core Temperature check 3</th>
                    ...
                    foreach($data as $row)
                    {
                        ...
                        <tr>
                            ...
                            <td>'.$row->sc4_mgr_supvsr_chk.'</td>
                            <td>'.$this->encrypt->decode($row->sc4_mgr_sign).'</td>
                            <td>'.$this->encrypt->decode($row->ud_fname).'</td>
                            <td><a href="'.base_url().'Admin/admin_sc4_view/'.$row->sc4_id.'" class="btn btn-primary" ><i class="glyphicon glyphicon-th-list" ></i></a></td>

                            <td><a href="'.base_url().'Admin/pdf_sc4/'.$row->sc4_id.'" class="btn btn-success"><i class="glyphicon glyphicon-download-alt"></i></a></td>
                        </tr>
                        ';
