<style>
 ...
 <script>
    ...
    <div class="content-wrap">
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1 style="color:green">AUDITOR PROFILE</span></h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
        ...
        <form action="<?php echo base_url(); ?>Auditor/change_auditor_password" method="post" id="validateForm" align="center">
 ...
 <div class="form-group">
        ...
        <input type="password" class="form-control"  name="auditor_password" id="auditor_password" placeholder="************" required="">
</div>
