            ...
            <div class="container-fluid">
                ...
                <table class="table table-striped table-bordered">
                   ...
                   //echo "<pre>"; print_r($data); die(); 
                    foreach($data as $row){ 
                    if (($row->noentrycountsc1==1)||($row->noentrycountsc2==1)||($row->noentrycountsc3==1)||($row->noentrycountsc4==1)) {
                        if ($row->createddatecount==1 || $row->createddatecount>0) {
...
if($row->noentrycountsc1==1){echo "SC1-(".$row->noentrycountsc1." days),";}
if($row->noentrycountsc2==1){echo " SC2-(".$row->noentrycountsc2." days) ,";}
if($row->noentrycountsc3==1){echo " SC3-(".$row->noentrycountsc3." days) ,";}
if($row->noentrycountsc4==1){echo " SC4-(".$row->noentrycountsc4." days) ";}
                           echo '</td>              
                        </tr>
                        ';
                       }
