        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div id="main-content">
                    <div class="row">
                        <br>
                 <a href="<?php echo base_url(); ?>Auditor/sc2_dwld_pdf" class="btn btn-success"><i class="glyphicon glyphicon-download-alt"></i> Download Records</a>
                 <br> <br>
                 <table class="table table-striped table-bordered">
                    ...
                    {  $date = $row->sc2_date; 
                        ...
                        <tr>
                            ...
                            <td><a href="'.base_url().'Auditor/auditor_sc2_view/'.$row->sc2_id.'" class="btn btn-primary" ><i class="glyphicon glyphicon-th-list" ></i></a></td>

                            <td><a href="'.base_url().'Auditor/pdf_sc2/'.$row->sc2_id.'" class="btn btn-success"><i class="glyphicon glyphicon-download-alt"></i></a></td>
                        </tr>
                        ';
